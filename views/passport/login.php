                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <!--Login Form-->
                                    <form class="user" action="<?=base_url?>passport-signin" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"
                                                id="user" aria-describedby="userHelp" name="user" 
                                        ...
                                        <div class="d-flex justify-content-center py-1">
                                            ...
                                            <?php elseif(isset($_SESSION['login']) && $_SESSION['login'] == 'empty'): ?>
                                                <div class="alert alert-warning alert-dismissible fade show" role="alert">
                                                    <strong>Please input your credentials.</strong>
                                                </div>
                                            <?php endif; ?>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="<?=base_url?>passport-register">Create an Account!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
