                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <div class="d-flex justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Data Table of User Events</h6>
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <?php $i = 1; foreach($users as $use): ?>
                                        <a class="dropdown-item tableUsers" datauser="<?php echo $use['id'];?>" 
                                        datastart="<?php echo $startDate;?>" dataend="<?php echo $endDate;?>">
                                        Generate Report for <?=$use['user']?>        
                                        </a>           
                                    <?php $i++; endforeach; ?>                       
                                </div>
                            </div>
